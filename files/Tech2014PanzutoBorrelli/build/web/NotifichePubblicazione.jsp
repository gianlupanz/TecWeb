<%-- 
    Document   : NotifichePubblicazione
    Created on : 21-gen-2015, 10.22.09
    Author     : iAngelo
--%>
...
<html>
        ...
        if (cnt > -1)
            ...
            function foo(modulo){
                ...
                if (btn== null)
                    ...
                    modulo.action='NotificaPubblicazione';
                    modulo.submit();
                }
    ...
    <body>
        <h1>Notifiche di Pubblicazione</h1><br>
        <%!
            ResultSet rs2;
        ...
        <%
            ...
            query2 = "Select Mittente,TitoloDocumento from NotifichePubblicazione where Destinatario = '"+utente2+"' AND Risposta!=1 ;";
            rs2 = Database.query(query2);
            if (!rs2.next()){
                out.println("<p>Non ci sono notifiche di Pubblicazione</p>");
        ...
        <%
                ...
                while(rs2.next()){
                    ...
                    out.println("<p>l'utente "+tmp+" vuole pubblicare "
                    ...
                    out.println("<input type = 'radio' name = 'risposta' id='rifiuta'"
                            + " value='Rifiuta'><br>");
                    out.println("<input type='button' name=pulsante value='invia' onclick=foo(condiviso"+count+")>");
                    out.println("</form>");
                }
        %>    
